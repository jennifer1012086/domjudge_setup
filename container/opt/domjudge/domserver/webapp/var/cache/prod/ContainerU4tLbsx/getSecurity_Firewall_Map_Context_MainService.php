...
class getSecurity_Firewall_Map_Context_MainService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 4), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($container->privates['security.authentication.trust_resolver'] ?? ($container->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), $b, 'main', ($container->privates['App\\Security\\DOMJudgeXHeadersAuthenticator'] ?? $container->load('getDOMJudgeXHeadersAuthenticatorService')), NULL, NULL, ($container->privates['monolog.logger.security'] ?? $container->getMonolog_Logger_SecurityService()), false), new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, ($container->privates['security.event_dispatcher.main'] ?? $container->getSecurity_EventDispatcher_MainService()), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout']), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'App\\Security\\UserChecker', '.security.request_matcher.3UEFixr', true, false, 'security.user.provider.concrete.domjudge_db_provider', 'main', 'App\\Security\\DOMJudgeXHeadersAuthenticator', NULL, NULL, [0 => 'form_login', 1 => 'App\\Security\\DOMJudgeXHeadersAuthenticator', 2 => 'App\\Security\\DOMJudgeIPAuthenticator'], NULL));
    }
}
