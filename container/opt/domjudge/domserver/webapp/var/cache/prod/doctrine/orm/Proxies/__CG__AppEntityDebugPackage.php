 ...
 */
class DebugPackage extends \App\Entity\DebugPackage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\DebugPackage' . "\0" . 'debug_package_id', '' . "\0" . 'App\\Entity\\DebugPackage' . "\0" . 'judging', '' . "\0" . 'App\\Entity\\DebugPackage' . "\0" . 'filename', '' . "\0" . 'App\\Entity\\DebugPackage' . "\0" . 'judgehost'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DebugPackage $proxy) {
    ...
    public function getDebugPackageId(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDebugPackageId', []);

        return parent::getDebugPackageId();
    }
     ...
     * {@inheritDoc}
     */
    public function setJudging(\App\Entity\Judging $judging): \App\Entity\DebugPackage
    {
     ...
     * {@inheritDoc}
     */
    public function setFilename(string $filename): \App\Entity\DebugPackage
    {
     ...
     * {@inheritDoc}
     */
    public function setJudgehost(\App\Entity\Judgehost $judgehost): \App\Entity\DebugPackage
    {
