...
class getClarificationControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator._2onP9j'] ?? $container->load('get_ServiceLocator_2onP9jService'))->withContext('App\\Controller\\API\\ClarificationController', $container));
