...
class TeamCategory extends \App\Entity\TeamCategory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'categoryid', 'externalid', 'icpcid', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'name', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'sortorder', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'color', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'visible', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'allow_self_registration', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'teams', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'contests', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'contests_for_medals'];
        }
     ...
     * {@inheritDoc}
     */
    public function setExternalid(?string $externalid): \App\Entity\TeamCategory
    {
     ...
     * {@inheritDoc}
     */
    public function setIcpcid(?string $icpcid): \App\Entity\TeamCategory
    {
     ...
     * {@inheritDoc}
     */
    public function setCategoryid(int $categoryid): \App\Entity\TeamCategory
    {
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \App\Entity\TeamCategory
    {
     ...
     * {@inheritDoc}
     */
    public function setSortorder(int $sortorder): \App\Entity\TeamCategory
    {
     ...
     * {@inheritDoc}
     */
    public function setColor(?string $color): \App\Entity\TeamCategory
    {
     ...
     * {@inheritDoc}
     */
    public function setVisible(bool $visible): \App\Entity\TeamCategory
    {
     ...
     * {@inheritDoc}
     */
    public function setAllowSelfRegistration(bool $allowSelfRegistration): \App\Entity\TeamCategory
    {
     ...
     * {@inheritDoc}
     */
    public function addTeam(\App\Entity\Team $team): \App\Entity\TeamCategory
    {
     ...
     * {@inheritDoc}
     */
    public function getContestsForMedals(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContestsForMedals', []);

        return parent::getContestsForMedals();
    }

    /**
     * {@inheritDoc}
     */
    public function addContestForMedals(\App\Entity\Contest $contest): \App\Entity\TeamCategory
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addContestForMedals', [$contest]);

        return parent::addContestForMedals($contest);
    }

    /**
     * {@inheritDoc}
     */
    public function removeContestForMedals(\App\Entity\Contest $contest): \App\Entity\TeamCategory
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeContestForMedals', [$contest]);

        return parent::removeContestForMedals($contest);
    }
